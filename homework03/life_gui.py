...
class GUI(UI):
    ...
    def draw_lines(self) -> None:
        for x in range(0, self.life.cols):
            pygame.draw.line(
                self.screen, pygame.Color("black"), (x*self.cell_size, 0), (x*self.cell_size, self.life.rows*self.cell_size)
            )
        for y in range(0, self.life.rows):
            pygame.draw.line(
                self.screen, pygame.Color("black"), (0, y*self.cell_size), (self.life.cols*self.cell_size, y*self.cell_size)
            )
